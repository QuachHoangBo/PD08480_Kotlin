...
fun HomeScreen(navController: NavController){
    ...
    ShopList.add(ShopModel("Áo phông rộng",R.drawable.image1,"23.000 đồng"))
    ShopList.add(ShopModel("Áo phông rộng",R.drawable.image2,"23.000 đồng"))
    ShopList.add(ShopModel("Áo phông rộng",R.drawable.image3,"23.000 đồng"))
